...
#
#@MD5TINOIGN@ Creation date: Thu Nov 10 15:21:53 CET 2016
#
# This file is based on following files:
#@MD5TINOIGN@ 1: Makefile.tino
#@MD5TINOIGN@ 2: /home/tino/src/killmem/tino/Makefile.proto
...
#
#@MD5TINOIGN@ included: /home/tino/src/killmem/tino/Makefile.proto
#
...
tino_sbrk.h:	Makefile.md5
	$(TOUCH) tino_sbrk.h

# compiler generated dependencies, remove if incorrect

# included: killmem.d
$(PROG1).o:  killmem.c tino_sbrk.h killmem_version.h
